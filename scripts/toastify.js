(function (root, factory) {
  ...
  Toastify.lib = Toastify.prototype = {
    ...
    buildToast: function () {
      ...
      if (typeof this.options.offset === "object") {
        ...
        let yOffset = this.options.gravity == "toastify-top" ? y : "-" + y;
    ...
    showToast: function () {
      ...
      let elementToInsert = Toastify.defaults.oldestFirst
  ...
  Toastify.reposition = function () {
    ...
    let allToasts = document.getElementsByClassName("toastify");
